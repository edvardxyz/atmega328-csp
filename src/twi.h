...
#define __TWI_H__
  ...
  // -------------------------------------------------------------------------------------
	...
	#define TWI_TWAR            TWAR0 // TWI (Slave) Address Register
	#define TWI_TWBR            TWBR0 // TWI Bit Rate Register
	#define TWI_TWDR            TWDR0 // TWI Data Register
	#define TWI_TWCR            TWCR0 // TWI Control Register
	#define TWI_TWSR            TWSR0 // TWI Status Register
  #endif
